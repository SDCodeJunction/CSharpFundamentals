...
namespace MultiDelegate
{
    ...
    public delegate void RectangleDelegate(double Width, double Height);  // declare
    public class Rectangle
    {
        public void GetArea(double Width, double Height)
        {
        ...
        static void Main(string[] args)
        {
            ...
            RectangleDelegate rectDelegate = new RectangleDelegate(rect.GetArea); // Create instance
            ...
            rectDelegate(23.45, 67.89);   // Invoke
